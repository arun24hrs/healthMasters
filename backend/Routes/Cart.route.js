...
cartRouter.post("/product/add",async(req,res)=>{
    ...
    if (req.body.product_img && req.body.product_name && req.body.product_price && req.body.product_desc && req.body.product_discounted_price && req.body.product_rating && req.body.product_type && req.body.product_weight && req.body.product_qty && req.body.user_id){
        try {
